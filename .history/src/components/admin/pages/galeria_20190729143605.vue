        ...
        <v-card-text>
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs12 v-if="form.file" style="justify-content: center; align-items: center">
...
export default {
  ...
  methods: {
    handleFile (evt) {
      ...
      const durl = evt.target.files.item(0)

      const preview = document.querySelector('img[class=preview]')
      console.log(preview)
      // preview.src = '../../../assets/logo-educa.png'
