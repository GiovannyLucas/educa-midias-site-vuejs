    ...
    <v-dialog v-model="dialog2" fullscreen hide-overlay transition="dialog-bottom-transition">
      <v-card>
        ...
        <v-list three-line subheader>
          <v-subheader class="header">{{ this.mensage[0] }}</v-subheader>
          <v-list-item><br>
            <v-list-item-content xs12>
              <v-list-item-title>{{ this.mensage[1] }}</v-list-item-title><br>
              <a :href="mensage[2]">URL Instagram <i class="fa fa-instagram"></i></a><br><br><br>
