        ...
        <v-card>
          ...
          <v-card-text>
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs6>
                  Quando deve começar a passar
                  <v-date-picker color="black" v-model="pickerInicio"></v-date-picker>
                </v-flex>
                <v-flex xs6>
                  Quando deve parar de passar
                  <v-date-picker color="black" v-model="pickerFim"></v-date-picker>
                </v-flex>
                <v-flex xs12>
