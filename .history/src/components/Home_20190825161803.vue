  ...
  <div>
    ...
    <v-divider></v-divider>
      ...
      <v-layout class="footer">
        <v-img
          class="footer-dev"
          scr="https://firebasestorage.googleapis.com/v0/b/site-educa-midias.appspot.com/o/sobre_nos%2Fcartaz03-1564941785016.jpg?alt=media&token=df948370-152a-48d1-b27d-898f33973e8d"
        ></v-img>
      </v-layout>
  </div>
</template>
